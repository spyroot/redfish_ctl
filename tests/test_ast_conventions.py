...
LEGACY_UNGUARDED_MUTATION_CALLS = {
    ...
    "redfish_ctl/virtual_media/cmd_smc_virtual_media.py:236 execute base_post",
    "redfish_ctl/virtual_media/cmd_smc_virtual_media.py:249 execute base_patch",
    "redfish_ctl/virtual_media/cmd_smc_virtual_media.py:256 execute base_post",
