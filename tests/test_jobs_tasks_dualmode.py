...
def test_job_delete_all_posts_clear_queue_payload_in_mock_mode(
    ...
    monkeypatch.setattr(CommandBase, "fetch_task", fetch_task)
...
def test_fetch_task_raises_authentication_failed_on_task_poll_401(
    ...
    monkeypatch.setattr(CommandBase, "get_job", get_job)
    monkeypatch.setattr(CommandBase, "api_get_call", api_get_call)
