...
def test_corpus_tree_conversion_routes_by_authority_not_filename_guessing():
    ...
    assert contract["lifecycle"]["state"] == "design-contract"
    assert contract["lifecycle"]["implementation_available"] is False
    ...
    assert "percent-decode-once-before-segmentation" in recovery[
