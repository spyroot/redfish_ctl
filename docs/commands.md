...
| `dell-raid-pd-actions` | List, preview, or run DellRaidService physical-disk actions (`ChangePDState`, `PrepareToRemove`, `RebuildPhysicalDisk`); requires `--confirm` to write. | Guarded |
