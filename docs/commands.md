...
| `dell-os-network-iso-actions` | List or invoke Dell OS deployment network ISO and VFlash share actions; previews by default and requires `--confirm` to write. | Guarded |
