...
from redfish_ctl.telemetry import identity  # noqa: E402
...
IDENTITY = identity.build_identity_dimensions(DEFAULT_LEAF, vendor="supermicro")
...
def _generic_exporter_name(metric_name: str) -> str:
    ...
    return f"`{super_microexporter._generic_metric_name(metric_name)}`"
