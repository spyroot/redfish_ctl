...
class ApiRequestType(Enum):
    ...
    SupermicroMetricReports = auto()
    SupermicroMetricReportDefinitions = auto()
    SupermicroTelemetryClearReports = auto()
    SupermicroTelemetryResetMetricDefinitions = auto()
    SupermicroTelemetrySubmitTest = auto()
    SupermicroTriggers = auto()
