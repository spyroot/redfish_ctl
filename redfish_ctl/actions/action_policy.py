...
ACTION_POLICY = {
    ...
    "#DellOSDeploymentService.ConfigurableBootToNetworkISO": Destructiveness.DESTRUCTIVE,
    "#DellOSDeploymentService.DownloadISOToVFlash": Destructiveness.DESTRUCTIVE,
    "#DellOSDeploymentService.UnpackAndAttach": Destructiveness.DESTRUCTIVE,
    "#DellOSDeploymentService.UnpackAndShare": Destructiveness.DESTRUCTIVE,
