...
from ..command_shared import ApiRequestType, RedfishCommandRespond, RedfishData, Singleton
from ..redfish_manager import CommandResult


class ChassisReset(CommandBase,
    ...
    def discover_reset(self, reset_type: str) -> str:
        ...
        redfish_action = chassis_data.discovered[RedfishData.Reset]
        ...
        if args and RedfishData.ResetType in args:
            args_options = args[RedfishData.ResetType]
    ...
    def execute(self,
        ...
        payload = {
            RedfishData.ResetType: reset_type
        }
