...
class _AccountBase(CommandBase):
    ...
    def _resolve_account(self, username: Optional[str],
        ...
        """
        coll = (self.base_query(RedfishEndpoint.Accounts).data or {})
...
class AccountCreate(_AccountBase,
    ...
    def execute(self, acct_user=None, acct_password=None, acct_role=DEFAULT_ROLE,
        ...
        res, status = self.base_post(RedfishEndpoint.Accounts, payload=payload, expected_status=201)
        return CommandResult(
